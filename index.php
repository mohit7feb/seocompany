      ...
      <div class="row">
        <div class="col-md-5">
          <div class="content-box">
            ...
            <a href="contact.php" class="btn btn-regular">Start Free Trial</a>
          </div>
        </div>
        <div class="col-md-7">
  ...
  <<section id="testimonials">
    <div class="container">
      <div class="title-block">
        <h2>Top Digital Marketing Experts Recommend Our Tools</h2>
        <p>Leading digital marketers share their experiences using our software and the outstanding results they’ve achieved.</p>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="testimonial-box">
            <div class="row personal-info">
              ...
              <div class="col-md-10 col-xs-10">
                ...
                <small>Digital Marketing Strategist | Author & Content Creator</small>
              </div>
            </div>
            <p>"This software has revolutionized how we analyze campaign performance. It’s intuitive, powerful, and provides the insights we need to optimize our strategies in real time."</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="testimonial-box">
            <div class="row personal-info">
              ...
              <div class="col-md-10 col-xs-10">
                ...
                <small>SEO Specialist | Author & Speaker</small>
              </div>
            </div>
            <p>"From SEO optimization to in-depth analytics, this software is essential for any digital marketer looking to stay ahead. The results speak for themselves—consistent traffic growth and improved ROI."</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-4">
          <div class="pricing-box">
            ...
            <div class="text-center">
              <a href="contact.php" class="btn btn-demo">Demo version</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="pricing-box">
            ...
            <div class="text-center">
              <a href="contact.php" class="btn btn-buy">Buy now</a>
            </div>
          </div>
        </div>
        <div class="col-md-4">
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <ul>
            ...
            <li><a href="#marketing">Features</a></li>
